    ...
    return (
        <>
            ...
            `layoutId` — which creates a shared layout animation. */}
                    ...
                    {/* ── Right Side: Track Order + Cart + Mobile Toggle ── */}
                    <div className="flex items-center gap-2 sm:gap-3">
                        {/* Track Order link */}
                        <Link
                            href="/track-order"
                            className="hidden sm:flex items-center gap-1.5 rounded-lg border border-white/10 px-3 py-2 text-xs font-medium text-white/50 hover:text-white hover:border-white/20 hover:bg-white/5 transition-all"
                        >
